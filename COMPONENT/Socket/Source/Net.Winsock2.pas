...
function Stub_TransmitPackets(s: TSocket; lpPacketArray: LPTRANSMIT_PACKETS_ELEMENT; nElementCount: DWORD; nSendSize: DWORD; lpOverlapped: LPWSAOVERLAPPED; dwFlags: DWORD): BOOL; stdcall;
begin
...
function WSAMakeSyncReply(Buflen, AError: Word): Longint; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := MakeLong(Buflen, AError);
end;

function WSAMakeSelectReply(Event, AError: Word): Longint; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := MakeLong(Event, AError);
end;

function WSAGetAsyncBuflen(Param: Longint): Word; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := LOWORD(Param);
end;

function WSAGetAsyncError(Param: Longint): Word; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := HIWORD(Param);
end;

function WSAGetSelectEvent(Param: Longint): Word; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := LOWORD(Param);
end;

function WSAGetSelectError(Param: Longint): Word; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
...
function FD_ISSET(ASocket: TSocket; var FDSet: TFDSet): Boolean; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := __WSAFDIsSet(ASocket, FDSet);
end;

procedure FD_SET(ASocket: TSocket; var FDSet: TFDSet); {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
...
procedure FD_ZERO(var FDSet: TFDSet); {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  FDSet.fd_count := 0;
end;
...
//Posix aliases
//    #define CMSGHDR_ALIGN WSA_CMSGHDR_ALIGN
function CMSGHDR_ALIGN(const Alength: SIZE_T): SIZE_T; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := WSA_CMSGHDR_ALIGN(Alength);
end;

// #define CMSGDATA_ALIGN WSA_CMSGDATA_ALIGN
function CMSGDATA_ALIGN(const Alength: UINT_PTR): UINT_PTR; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := WSA_CMSGDATA_ALIGN(Alength);
end;

//#define CMSG_FIRSTHDR WSA_CMSG_FIRSTHDR
function CMSG_FIRSTHDR(const msg: LPWSAMSG): LPWSACMSGHDR; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := WSA_CMSG_FIRSTHDR(msg);
end;

// #define CMSG_NXTHDR WSA_CMSG_NXTHDR
function CMSG_NXTHDR(const msg: LPWSAMSG; const cmsg: LPWSACMSGHDR): LPWSACMSGHDR; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := WSA_CMSG_NXTHDR(msg, cmsg);
end;

// #define CMSG_SPACE WSA_CMSG_SPACE
function CMSG_SPACE(const Alength: UINT_PTR): UINT_PTR; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := WSA_CMSG_SPACE(ALength);
end;

// #define CMSG_LEN WSA_CMSG_LEN
function CMSG_LEN(const Alength: SIZE_T): SIZE_T; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
...
function WSA_CMSGDATA_ALIGN(const Alength: UINT_PTR): UINT_PTR; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := (Alength + MAX_NATURAL_ALIGNMENT_SUB_1) and not (MAX_NATURAL_ALIGNMENT_SUB_1);
end;

function WSA_CMSG_FIRSTHDR(const msg: LPWSAMSG): LPWSACMSGHDR; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
...
function WSA_CMSG_NXTHDR(const msg: LPWSAMSG; const cmsg: LPWSACMSGHDR): LPWSACMSGHDR; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
...
function WSA_CMSG_DATA(const cmsg: LPWSACMSGHDR): PByte; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := PByte(UINT_PTR(cmsg) + WSA_CMSGDATA_ALIGN(SIZE_WSACMSGHDR));
end;

function WSA_CMSG_SPACE(const Alength: UINT_PTR): UINT_PTR; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := WSA_CMSGDATA_ALIGN(UINT_PTR(SIZE_WSACMSGHDR + WSA_CMSGHDR_ALIGN(Alength)));
end;

function WSA_CMSG_LEN(const Alength: SIZE_T): SIZE_T; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := (WSA_CMSGDATA_ALIGN(SizeOf(WSACMSGHDR)) + Alength);
end;

function IP_MSFILTER_SIZE(const numsrc: DWORD): UINT_PTR; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  Result := SIZE_IP_MSFILTER - SIZE_TINADDR + (numsrc*SIZE_TINADDR);
end;

function SS_PORT(ssp: PSockAddrIn): u_short; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
...
function IN6_IS_ADDR_EUI64(const a : PIn6Addr) : Boolean; {$IFDEF USE_INLINE}inline;{$ENDIF}
    //
...
function IN6_IS_ADDR_SUBNET_ROUTER_ANYCAST(const a : PIn6Addr) : Boolean; {$IFDEF USE_INLINE}inline;{$ENDIF}
//
...
function IN6_IS_ADDR_SUBNET_RESERVED_ANYCAST(const a: PIn6Addr) : Boolean; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
   if a <> nil then begin
...
function IN6_IS_ADDR_ANYCAST(const a: PIn6Addr) : Boolean; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  if a <> nil then begin
...
procedure IN6_SET_ADDR_UNSPECIFIED(a : PIN6_ADDR); {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
   system.FillChar(a^.s6_addr, SizeOf(IN6_ADDR), 0 );
end;

procedure IN6_SET_ADDR_LOOPBACK(a : PIN6_ADDR); {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
  system.FillChar(a^.s6_addr, SizeOf(IN6_ADDR), 0 );
  a^.s6_addr[15] := 1;
end;
...
function GROUP_FILTER_SIZE(const numsrc : DWord) : UINT_PTR; {$IFDEF USE_INLINE}inline;{$ENDIF}
begin
