...
function epoll_create(size: Integer): Integer; cdecl; external libc name _PU + 'epoll_create'; {$EXTERNALSYM epoll_create}
{ control interface for an epoll descriptor }
function epoll_ctl(epfd, op, fd: Integer; event: pepoll_event): Integer; cdecl; external libc name _PU + 'epoll_ctl'; {$EXTERNALSYM epoll_ctl}
{ wait for an I/O event on an epoll file descriptor }
function epoll_wait(epfd: Integer; events: pepoll_event; maxevents, timeout: Integer): Integer; cdecl; external libc name _PU + 'epoll_wait'; {$EXTERNALSYM epoll_wait}
{ create a file descriptor for event notification }
function eventfd(initval: Cardinal; flags: Integer): Integer; cdecl; external libc name _PU + 'eventfd'; {$EXTERNALSYM eventfd}
