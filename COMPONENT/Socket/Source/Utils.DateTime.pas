...
begin
  Result := (Self.ToMilliseconds - ADateTime.ToMilliseconds) div (MSecsPerSec * SecsPerMin * MinsPerHour);
end;
...
begin
  Result := (Self.ToMilliseconds - ADateTime.ToMilliseconds) div (MSecsPerSec * SecsPerMin);
end;
...
begin
  Result := (Self.ToMilliseconds - ADateTime.ToMilliseconds) div Round(CMillisPerDay * ApproxDaysPerMonth);
end;
...
begin
  Result := (Self.ToMilliseconds - ADateTime.ToMilliseconds) div (MSecsPerSec);
end;
...
begin
  Result := (Self.ToMilliseconds - ADateTime.ToMilliseconds) div (CMillisPerDay * DaysPerWeek);
end;
...
begin
  Result := (Self.ToMilliseconds - ADateTime.ToMilliseconds) div Round(CMillisPerDay * ApproxDaysPerYear);
end;
