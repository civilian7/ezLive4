...
function  kqueue: Integer; cdecl; external libc name _PU + 'kqueue'; {$EXTERNALSYM kqueue}
function  kevent(kq: Integer; ChangeList: PKEvent; nChanged: Integer; EventList: PKevent; nEvents: Integer; Timeout: PTimeSpec): Integer; cdecl; external libc name _PU + 'kevent'; {$EXTERNALSYM kevent}
procedure EV_SET(kevp: PKEvent; const aIdent: UIntPtr; const aFilter: SmallInt; const aFlags: Word; const aFFlags: Cardinal; const aData: IntPtr; const auData: Pointer); inline;
