...
type
  ...
  public
    ...
    procedure ShowPanel(AForm: TCustomForm; AColor: TColor; AColorAlpha: Byte; ABlurAmount: TscBlurAmount);
    procedure HidePanel;
  end;
  ...
  published
    ...
    property HotImageIndex: Integer read FHotImageIndex write FHotImageIndex default -1;
    property PressedImageIndex: Integer read FPressedImageIndex write FPressedImageIndex default -1;
    ...
    property CustomDropDown: Boolean read FCustomDropDown write FCustomDropDown;
    property Hint: String read FHint write FHint;
    property OnPaint: TscPaintNCButtonEvent read FOnPaint write FOnPaint;
    property OnGetPaintParams: TscPaintParamsNCButtonEvent read FOnGetPaintParams write FOnGetPaintParams;
    property OnClick: TNotifyEvent read FOnClick write FOnClick;
    property OnMouseEnter: TscNCMouseEvent read FOnMouseEnter write FOnMouseEnter;
    property OnMouseLeave: TscNCMouseEvent read FOnMouseLeave write FOnMouseLeave;
    property OnMouseUp: TscNCMouseXYEvent read FOnMouseUp write FOnMouseUp;
    property OnMouseDown: TscNCMouseXYEvent read FOnMouseDown write FOnMouseDown;
    property OnMouseMove: TscNCMouseXYEvent read FOnMouseMove write FOnMouseMove;
    property OnCloseUp: TscNCButtonCloseUpEvent read FOnCloseUp write FOnCloseUp;
    property OnDropDown: TscNCButtonDropDownEvent read FOnDropDown write FOnDropDown;
  end;
  ...
  TscPaintNCTabEvent = procedure(AIndex: Integer; ACanvas: TCanvas; ARect: TRect; AMouseIn, AActive: Boolean) of object;
  TscPaintParamsNCTabEvent = procedure(AIndex: Integer; ACanvas: TCanvas; ARect: TRect; AMouseIn, AActive: Boolean; var AHandled: Boolean) of object;
  ...
  published
    ...
    property Spacing: Integer read FSpacing write SetSpacing;
    property Hint: String read FHint write FHint;
    property OnPaint: TscPaintNCTabEvent read FOnPaint write FOnPaint;
    property OnGetPaintParams: TscPaintParamsNCTabEvent read FOnGetPaintParams write FOnGetPaintParams;
    property OnClick: TNotifyEvent read FOnClick write FOnClick;
    property OnMouseEnter: TscNCMouseEvent read FOnMouseEnter write FOnMouseEnter;
    property OnMouseLeave: TscNCMouseEvent read FOnMouseLeave write FOnMouseLeave;
    property OnMouseUp: TscNCMouseXYEvent read FOnMouseUp write FOnMouseUp;
  ...
  published
    property FluentUIBackground: TscFluentUIBackground read FFluentUIBackground write SetFluentUIBackground;
    property FluentUIAcrylicColor: TColor read FFluentUIAcrylicColor write SetFluentUIAcrylicColor;
    property FluentUIAcrylicColorAlpha: Byte read FFluentUIAcrylicColorAlpha write SetFluentUIAcrylicColorAlpha;
    property FluentUIBorder: Boolean read FFluentUIBorder write SetFluentUIBorder;
    property FluentUIInactiveAcrylicColorOpaque: Boolean read FFluentUIInactiveAcrylicColorOpaque write FFluentUIInactiveAcrylicColorOpaque;
    property DWMClientRoundedCornersType: TscDWMRoundedCornersType read FDWMClientRoundedCornersType write SetDWMClientRoundedCornersType;
    property DWMClientShadow: Boolean read FDWMClientShadow write SetDWMClientShadow;
    property DWMClientShadowHitTest: Boolean read FDWMClientShadowHitTest write SetDWMClientShadowHitTest;
    property DropDownForm: Boolean read FDropDownForm write SetDropDownForm;
    property DropDownAnimation: Boolean read FDropDownAnimation write FDropDownAnimation;
    property DropDownBorderColor: TColor read FDropDownBorderColor write FDropDownBorderColor;
    ...
    property ButtonImages: TCustomImageList read FButtonImages write FButtonImages;
    ...
    property InActiveClientColor: TColor read FInActiveClientColor write FInActiveClientColor;
    property InActiveClientColorAlpha: Byte read FInActiveClientColorAlpha write FInActiveClientColorAlpha;
    property InActiveClientBlurAmount: TscBlurAmount read FInActiveClientBlurAmount write FInActiveClientBlurAmount;
    property Tabs: TscNCTabItems read FTabs write SetTabs;
    property TabImages: TCustomImageList read FTabImages write FTabImages;
    ...
    property CaptionWallpaperLeftMargin: Integer read FCaptionWallpaperLeftMargin write SetCaptionWallpaperLeftMargin;
    property CaptionWallpaperTopMargin: Integer read FCaptionWallpaperTopMargin write SetCaptionWallpaperTopMargin;
    property CaptionWallpaperRightMargin: Integer read FCaptionWallpaperRightMargin write SetCaptionWallpaperRightMargin;
    property CaptionWallpaperBottomMargin: Integer read FCaptionWallpaperBottomMargin write SetCaptionWallpaperBottomMargin;
    ...
    property OnHitTest: TscNCHitTestEvent read FOnHitTest write FOnHitTest;
    property OnChangeActive: TNotifyEvent read FOnChangeActive write FOnChangeActive;
    property OnBeforeChangeScale: TNotifyEvent read FOnBeforeChangeScale write FOnBeforeChangeScale;
    property OnChangeScale: TscOnChangeScaleEvent read FOnChangeScale write FOnChangeScale;
    property OnDropDown: TscOnFormDropDownEvent read FOnDropDown write FOnDropDown;
    property OnCloseUp: TscOnFormCloseUpEvent read FOnCloseUp write FOnCloseUp;
    property OnDWMClientMaximize: TNotifyEvent read FOnDWMClientMaximize write FOnDWMClientMaximize;
    property OnDWMClientRestore: TNotifyEvent read FOnDWMClientRestore write FOnDWMClientRestore;
  end;
