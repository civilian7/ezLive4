...
type
  ...
  published
    ...
    property CustomOverContentImageIndex: Integer read FCustomOverContentImageIndex write SetCustomOverContentImageIndex;
  ...
  TscDrawAdvancedListItemEvent = procedure(Cnvs: TCanvas; Index: Integer; TextRct: TRect) of object;
  ...
  published
    ...
    property GroupBackgroundColor: TColor read FGroupBackgroundColor write SetGroupBackgroundColor;
    property GroupBackgroundCustomImageIndex: Integer read FGroupBackgroundCustomImageIndex write SetGroupBackgroundCustomImageIndex;
    property SelectionStyle;
    property SelectionColor;
    property SelectionTextColor;
    property ShowFocusRect;
    property SelectionGlow;
    property Style: TscAdvancedListBoxStyle read FStyle write SetStyle;
    ...
    property ShowItemDetails: Boolean read FShowItemDetails write SetShowItemDetails;
    property ShowItemProgressBars: Boolean read FShowItemProgressBars write SetShowItemProgressBars;
    property ItemProgressBarWidth: Integer read FItemProgressBarWidth write SetItemProgressBarWidth;
    property ItemProgressBarHeight: Integer read FItemProgressBarHeight write SetItemProgressBarHeight;
    property ItemSpacing: Integer read FItemSpacing write SetItemSpacing;
    property ShowItemTitles: Boolean read FShowItemTitles write SetShowItemTitles;
    ...
    property MouseMoveChangeIndex: Boolean read FMouseMoveChangeIndex write FMouseMoveChangeIndex;
    property TitleFont: TFont read FTitleFont write SetTitleFont;
    property HeaderFont: TFont read FHeaderFont write SetHeaderFont;
    property DetailFont: TFont read FDetailFont write SetDetailFont;
    property DetailPosition: TscListBoxDetailPosition read FDetailPosition write SetDetailPosition;
    property DetailWordWrap: Boolean read FDetailWordWrap write SetDetailWordWrap;
    ...
    property ShowHint;
    property Visible;
    property OnDrawItem: TscDrawAdvancedListItemEvent read FOnDrawItem write FOnDrawItem;
    property OnItemClick: TNotifyEvent read FOnItemClick write FOnItemClick;
    property OnItemCheckClick: TNotifyEvent read FOnItemCheckClick write FOnItemCheckClick;
  ...
  protected
    ...
    property CustomImages: TscCustomImageCollection read FCustomImages write SetCustomImages;
    property CustomImageNormalIndex: Integer read FCustomImageNormalIndex write SetCustomImageNormalIndex;
    property CustomImageHotIndex: Integer read FCustomImageHotIndex write SetCustomImageHotIndex;
    property CustomImagePressedIndex: Integer read FCustomImagePressedIndex write SetCustomImagePressedIndex;
    property CustomImageDisabledIndex: Integer read FCustomImageDisabledIndex write SetCustomImageDisabledIndex;
    property CustomImageFocusedIndex: Integer read FCustomImageFocusedIndex write SetCustomImageFocusedIndex;
    property CustomArrowImageNormalIndex: Integer read FCustomArrowImageNormalIndex write SetCustomArrowImageNormalIndex;
    property CustomArrowImageHotIndex: Integer read FCustomArrowImageHotIndex write SetCustomArrowImageHotIndex;
    property CustomArrowImagePressedIndex: Integer read FCustomArrowImagePressedIndex write SetCustomArrowImagePressedIndex;
    property CustomArrowImageDisabledIndex: Integer read FCustomArrowImageDisabledIndex write SetCustomArrowImageDisabledIndex;
    property CustomArrowImageFocusedIndex: Integer read FCustomArrowImageFocusedIndex write SetCustomArrowImageFocusedIndex;
    property DropDownPosition: TscDropDownPosition read FDropDownPosition write FDropDownPosition default scdpRight;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
  published
    property UseFontColorToStyleColor: Boolean read FUseFontColorToStyleColor write FUseFontColorToStyleColor;
  end;
  ...
  public
    ...
    property CheckedListMode: Boolean read FCheckedListMode write SetCheckedListMode;
    property CheckedListWrap: Boolean read FCheckedListWrap write SetCheckedListWrap;

    property DetailPosition: TscListBoxDetailPosition read GetDetailPosition write SetDetailPosition;
    property DetailWordWrap: Boolean read GetDetailWordWrap write SetDetailWordWrap;
    ...
    property ListBoxHeaderUseStyleColor: Boolean read GetListBoxHeaderUseStyleColor write SetListBoxHeaderUseStyleColor;
    property ListBoxWallpapers: TscCustomImageCollection read FListBoxWallpapers write SetListBoxWallpapers;
    property ListBoxWallpaperIndex: Integer read FListBoxWallpaperIndex write SetListBoxWallpaperIndex;
    property ListBoxLineColor: TColor read GetListBoxLineColor write SetListBoxLineColor;
    property ListBoxHeaderStyle: TscAdvancedHeaderStyle read GetListBoxHeaderStyle write SetListBoxHeaderStyle;
    ...
    property ListBoxSelectionStyle:  TscAdvancedSelectionStyle read GetListBoxSelectionStyle write SetListBoxSelectionStyle;

    property ListBoxIndentMargin: Integer read GetListBoxIndentMargin write SetListBoxIndentMargin;

    property ListBoxSelectionColor: TColor read GetListBoxSelectionColor  write SetListBoxSelectionColor;

    property ListBoxSelectionTextColor: TColor read GetListBoxSelectionTextColor  write SetListBoxSelectionTextColor;

    property ListBoxShowItemTitles: Boolean read GetListBoxShowItemTitles write SetListBoxShowItemTitles;

    property ListBoxShowItemDetails: Boolean read GetListBoxShowItemDetails write SetListBoxShowItemDetails;

    property ListBoxShowLines: Boolean read GetListBoxShowLines write SetListBoxShowLines;
    property ListBoxItemHeight: Integer read GetListBoxItemHeight write SetListBoxItemHeight;
    property ListBoxHeaderHeight: Integer read GetListBoxHeaderHeight write SetListBoxHeaderHeight;

    property ListBoxCustomHeaderImageIndex: Integer read GetListBoxCustomHeaderImageIndex write SetListBoxCustomHeaderImageIndex;
    property ListBoxCustomSelectionImageIndex: Integer read GetListBoxCustomSelectionImageIndex write SetListBoxCustomSelectionImageIndex;
