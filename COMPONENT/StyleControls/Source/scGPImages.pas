...
type
  ...
  published
    ...
    property InterpolationMode: TscGPInterpolationMode read FInterpolationMode write SetInterpolationMode;

    property ClipFrame: TscGPImageClipFrame read FClipFrame write SetClipFrame;
    property ClipFrameRadius: Integer read FClipFrameRadius write SetClipFrameRadius;
    property ClipFrameFillColor: TColor read FClipFrameFillColor write SetClipFrameFillColor;
    property ClipFrameFillColorAlpha: Byte read FClipFrameFillColorAlpha write SetClipFrameFillColorAlpha;
    property ClipFrameColor: TColor read FClipFrameColor write SetClipFrameColor;
    property ClipFrameWidth: Integer read FClipFrameWidth write SetClipFrameWidth;
    ...
    property AnimationAcceleration: Boolean read FAnimationAcceleration write FAnimationAcceleration;

    property RotateAnimation: Boolean read FRotateAnimation write SetRotateAnimation;
  ...
  public
    ...
    procedure LoadPngFromResourceName(Instance: THandle; const ResName: String);
  ...
  published
    ...
    property Options: TscGPBitmapOptions read FOptions write FOptions;
    ...
    property PixelOffsetModeHighQuality: Boolean read FPixelOffsetModeHighQuality write FPixelOffsetModeHighQuality;
    property InterpolationModeHighQuality: Boolean read FInterpolationModeHighQuality write FInterpolationModeHighQuality;
  end;
  ...
  protected
    ...
    procedure DoDrawInternal(Index: Integer; Canvas: TCanvas; X, Y: Integer; Style: Cardinal; Enabled: Boolean = True);
  ...
  published
    property ColorDepth;
    property DirectDraw: Boolean read FDirectDraw write SetDirectDraw;
    property PixelOffsetMode: TscGPPixelOffsetMode read FPixelOffsetMode write FPixelOffsetMode;
    property InterpolationMode: TscGPInterpolationMode read FInterpolationMode write FInterpolationMode;
    property Width;
    property Height;
    property DefaultWidth: Integer read FDefaultWidth write FDefaultWidth default 16;
    property DefaultHeight: Integer read FDefaultHeight write FDefaultHeight default 16;
    property SourceImageList: TImageList read FSourceImageList write SetSourceImageList;
    property SourceImageCollection: TscGPImageCollection read FSourceImageCollection write SetSourceImageCollection;
  end;
