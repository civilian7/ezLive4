...
type
  ...
  protected
    ...
    property AnimationType: TscSplitViewAnimationType read FAnimationType write FAnimationType;
    ...
    property DisplayMode: TscSplitViewDisplayMode read FDisplayMode write SetDisplayMode;
    ...
    property OpenedMinWidth: Integer read FOpenedMinWidth write FOpenedMinWidth;
    property OpenedMaxWidth: Integer read FOpenedMaxWidth write FOpenedMaxWidth;
    property OpenedMinHeight: Integer read FOpenedMinHeight write FOpenedMinHeight;
    property OpenedMaxHeight: Integer read FOpenedMaxHeight write FOpenedMaxHeight;
  ...
  public
    ...
    property Items[Index: Integer]: TscSplitViewHistoryItem read GetItem write SetItem; default;
  end;
  ...
  public
    ...
    procedure CloseAll;
  published
    property PageViewer: TscPageViewer read FPageViewer write SetPageViewer;
    property BottomSplitView: TscSplitView read FBottomSplitView write SetBottomSplitView;
    property AnimationStep;
    property BiDiMode;
    property Color;
    property CompactWidth;
    ...
    property OnShowBackButton: TNotifyEvent read FOnShowBackButton write FOnShowBackButton;
    property OnHideBackButton: TNotifyEvent read FOnHideBackButton write FOnHideBackButton;
    property OnShowPageViewer: TNotifyEvent read FOnShowPageViewer write FOnShowPageViewer;
    property OnHidePageViewer: TNotifyEvent read FOnHidePageViewer write FOnHidePageViewer;
    property OnAlignInsertBefore;
    property OnAlignPosition;
    property OnCanResize;
    property OnClick;
  ...
  protected
    ...
    property FramePressedImageIndex: Integer read FFramePressedImageIndex write SetFramePressedImageIndex;
    ...
    property ThumbPressedImageIndex: Integer read FThumbPressedImageIndex write SetThumbPressedImageIndex;
  ...
  protected
    ...
    property SwitchWidth: Integer read FSwitchWidth write SetSwitchWidth;
    property SwitchHeight: Integer read FSwitchHeight write SetSwitchHeight;
    property StyleKind: TscSwitchStyleKind read FStyleKind write SetStyleKind;
