...
interface
  ...
  procedure DrawSegmentedButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; ADrawFocusRect: Boolean; ADrawCode: Integer; AScaleDrawFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawSegmentedToolButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; ADrawCode: Integer; AScaleDrawFactor: Double = 1{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawSplitButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; ADroppedDown: Boolean; AChevronWidth: Integer{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  procedure DrawSplitToolButton(ACanvas: TCanvas; ARect: TRect; ACtrlState: TscsCtrlState; ADroppedDown: Boolean; AChevronWidth: Integer{$IFDEF VER340_UP}; AControl: TControl = nil{$ENDIF});
  ...
  function Bitmap_GetFromImageList(IL: TCustomImageList; AIndex: Integer; B: TBitmap): Boolean;
  function Bitmap_GetFromImageListNoPremultiplied(IL: TCustomImageList; AIndex: Integer; B: TBitmap; ACheckAlpha: Boolean): Boolean;
  ...
  procedure DrawStrecthBitmap(ALeftOffset, ATopOffset, ARightOffset, ABottomOffset: Integer; ABitmap: TBitmap; ACanvas: TCanvas; ARect: TRect);
  // other
  ...
  SC_EndBufferedAnimation: function (hbpAnimation: SC_HANIMATIONBUFFER; fUpdateTarget: BOOL): HResult; stdcall;
...
uses
 ...
 System.Math,
 System.UITypes,
 WinApi.CommCtrl{$IFDEF GPDRAWING},scGPUtils{$ENDIF};
